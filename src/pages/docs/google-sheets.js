        ...
        <div className="w-full max-w-none prose px-4 md:px-8 text-text-primary">
          ...
          <article className="xl:w-10/12 p-8 justify-center mx-auto text-text-primary article-sheets">
            ...
            <p className="text-center p-3">
              Vamos a empezar por crear nuestra tabla en Excel con hojas de
              cálculo de google.
            </p>
            <p className="list-css-span">
              Creamos una nueva hoja de cálculo y la llenamos con nuestros
              ...
              obtener más información. Puedes proporcionar una ubicación de
              algún enlace de imagen; por ejemplo, en mi caso, he utilizado
              imágenes de un repositorio de GitHub y, para probar, un enlace de
              Google Fotos.
            </p>
            ...
            <p>
              Copiamos y pegamos el link en nuestro componente de Reactjs con
              Nextjs y Api Routes.
            </p>
            <p className="list-css-span">
              En nuestro componente vamos a escribir como lo hago aquí, en
              principio he usado<span>useState y useEffect</span>de la siguiente
              manera:
            </p>
            <Pre
              lang="tsx"
            ...
            >{`
                    ...
                    `}</Pre>
            <p className="list-css-span">
              Explicando un poco el desglose del código, en la obtención
              asíncrona de datos mediante el uso de useEffect, creamos una
              constante
              <span>response</span> que espera la respuesta de nuestro archivo
              de Google Sheets. Además, creamos una constante<span>csv</span>que
              espera el archivo en formato "CSV" y extrae su texto.
            </p>
            <pre
              lang="javascript"
              className="code-block text-zinc-100 p-1 my-2"
            >
            ...
            <p>
              Para formatear el archivo y aplicarlo a nuestra app, tenemos que
              crear una constante:
            </p>
            <pre
              lang="javascript"
            ...
            <p className="list-css-span">
              El<span>split('\n')</span>nos da el formato respetando separando
              cada texto por un salto de línea.
            </p>
            <p className="list-css-span">
