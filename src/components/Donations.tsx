...
export const Donations = () => {
  return (
    <Link
      className={`w-fit border border-zinc-100 dark:border-zinc-800/50 p-3 my-16 rounded-[14px] flex justify-center mx-auto items-center 
        cursor-pointer gap-2 bg-zinc-900 relative hover:brightness-125 transition-all duration-300`}
